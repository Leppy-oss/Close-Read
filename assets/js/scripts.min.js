!function(){for(var t=document.body.getAttribute("data-baseurl"),e=document.querySelectorAll("h1[id],h2[id],h3[id],h4[id],h5[id],h6[id]"),i=0;i<e.length;i++){var d=document.createElement("img"),r=(d.setAttribute("src",t+"/assets/img/link-symbol.svg"),document.createElement("a"));r.setAttribute("href","#"+e[i].getAttribute("id")),r.classList.add("anchor"),r.appendChild(d),e[i].insertBefore(r,e[i].firstChild)}}();
...
!function(){"use strict";var s,c,a,d,u,l,t=document.querySelector(".post-content"),m=document.querySelector(".time-bar"),p=!0;t&&m&&(s=0,c=t.scrollHeight,a=m.querySelector(".completed"),d=m.querySelector(".remaining"),u=m.querySelector(".time-completed"),l=m.querySelector(".time-remaining"),document.addEventListener("scroll",function(){var t,e,n,r,i=window.scrollY||document.documentElement.scrollTop,o=(m.style.bottom=(s<i||100<i)&&p?"0%":"-100%",Math.min(1,1.25*i/c));1<=o?(a.style.width="100%",d.style.width="0%",r=(r=parseInt(m.getAttribute("data-minutes")))<10?"0"+r:r,u.innerText="00:00",l.innerText=r+":00",p=!1,(r=document.createEvent("CustomEvent")).initCustomEvent("finishedReading"),document.dispatchEvent(r)):(r=(100*o).toFixed(2),e=100-parseFloat(r),a.style.width=r.toString()+"%",d.style.width=e.toString()+"%",e=60*parseInt(m.getAttribute("data-minutes")),o=parseInt(o*e),n=parseInt(o/60),t=parseInt(60*(o/60-n)),e=e-o,o=parseInt(e/60),e=parseInt(60*(e/60-o)),o=o<10?"0"+o:o,e=e<10?"0"+e:e,u.innerText=(n=n<10?"0"+n:n)+":"+(t=t<10?"0"+t:t),l.innerText=o+":"+e,p=!0,(n=document.createEvent("CustomEvent")).initCustomEvent("stillReading"),document.dispatchEvent(n)),s=i}))}();
